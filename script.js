...
const verbs = {
    ...
    jalasa: { en: "sit", pastEn: "sat", part: "sat", ar: {
    ...
    qaraa: { en: "read", pastEn: "read", part: "read", ar: {
    ...
    dakhala: { en: "enter", pastEn: "entered", part: "entered", ar: {
        past: { "3sm":"دَخَلَ", "3dm":"دَخَلَا", "3pm":"دَخَلُوا", "3sf":"دَخَلَتْ", "3df":"دَخَلَتَا", "3pf":"دَخَلْنَ", "2sm":"دَخَلْتَ", "2dm":"دَخَلْتُمَا", "2pm":"دَخَلْتُمْ", "2sf":"دَخَلْتِ", "2df":"دَخَلْتُمَا", "2pf":"دَخَلْتُنَّ", "1s":"دَخَلْتُ", "1p":"دَخَلْنَا" },
    ...
    faala: { en: "do", pastEn: "did", part: "done", ar: {
        past: { "3sm":"فَعَلَ", "3dm":"فَعَلَا", "3pm":"فَعَلُوا", "3sf":"فَعَلَتْ", "3df":"فَعَلَتَا", "3pf":"فَعَلْنَ", "2sm":"فَعَلْتَ", "2dm":"فَعَلْتُمَا", "2pm":"فَعَلْتُمْ", "2sf":"فَعَلْتِ", "2df":"فَعَلْتُمَا", "2pf":"فَعَلْتُنَّ", "1s":"فَعَلْتُ", "1p":"فَعَلْنَا" },
    ...
    rakiba: { en: "ride", pastEn: "rode", part: "ridden", ar: {
        past: { "3sm":"رَكِبَ", "3dm":"رَكِبَا", "3pm":"رَكِبُوا", "3sf":"رَكِبَتْ", "3df":"رَكِبَتَا", "3pf":"رَكِبْنَ", "2sm":"رَكِبْتَ", "2dm":"رَكِبْتُمَا", "2pm":"رَكِبْتُمْ", "2sf":"رَكِبْتِ", "2df":"رَكِبْتُمَا", "2pf":"رَكِبْتُنَّ", "1s":"رَكِبْتُ", "1p":"رَكِبْنَا" },
    ...
    nazara: { en: "look", pastEn: "looked", part: "looked", ar: {
        past: { "3sm":"نَظَرَ", "3dm":"نَظَرَا", "3pm":"نَظَرُوا", "3sf":"نَظَرَتْ", "3df":"نَظَرَتَا", "3pf":"نَظَرْنَ", "2sm":"نَظَرْتَ", "2dm":"نَظَرْتُمَا", "2pm":"نَظَرْتُمْ", "2sf":"نَظَرْتِ", "2df":"نَظَرْتُمَا", "2pf":"نَظَرْتُنَّ", "1s":"نَظَرْتُ", "1p":"نَظَرْنَا" },
    ...
    samia: { en: "hear", pastEn: "heard", part: "heard", ar: {
        past: { "3sm":"سَمِعَ", "3dm":"سَمِعَا", "3pm":"سَمِعُوا", "3sf":"سَمِعَتْ", "3df":"سَمِعَتَا", "3pf":"سَمِعْنَ", "2sm":"سَمِعْتَ", "2dm":"سَمِعْتُمَا", "2pm":"سَمِعْتُمْ", "2sf":"سَمِعْتِ", "2df":"سَمِعْتُمَا", "2pf":"سَمِعْتُنَّ", "1s":"سَمِعْتُ", "1p":"سَمِعْنَا" },
    ...
    daraba: { en: "hit", pastEn: "hit", part: "hit", ar: {
        past: { "3sm":"ضَرَبَ", "3dm":"ضَرَبَا", "3pm":"ضَرَبُوا", "3sf":"ضَرَبَتْ", "3df":"ضَرَبَتَا", "3pf":"ضَرَبْنَ", "2sm":"ضَرَبْتَ", "2dm":"ضَرَبْتُمَا", "2pm":"ضَرَبْتُمْ", "2sf":"ضَرَبْتِ", "2df":"ضَرَبْتُمَا", "2pf":"ضَرَبْتُنَّ", "1s":"ضَرَبْتُ", "1p":"ضَرَبْنَا" },
        present: { "3sm":"يَضْرِبُ", "3dm":"يَضْرِبَانِ", "3pm":"يَضْرِبُونَ", "3sf":"تضْرِبُ", "3df":"تَضْرِبَانِ", "3pf":"يَضْرِبْنَ", "2sm":"تَضْرِبُ", "2dm":"تَضْرِبَانِ", "2pm":"تَضْرِبُونَ", "2sf":"تَضْرِبِينَ", "2df":"تَضْرِبَانِ", "2pf":"تَضْرِبْنَ", "1s":"أَضْرِبُ", "1p":"نَضْرِبُ" },
        order: { "2sm":"اِضْرِبْ", "2sf":"اِضْرِبِي", "2dm":"اِضْرِبَا", "2df":"اِضْرِبَا", "2pm":"اِضْرِبُوا", "2pf":"اِضْرِبْنَ" }
    }},
    arafa: { en: "know", pastEn: "knew", part: "known", ar: {
        past: { "3sm":"عَرَفَ", "3dm":"عَرَفَا", "3pm":"عَرَفُوا", "3sf":"عَرَفَتْ", "3df":"عَرَفَتَا", "3pf":"عَرَفْنَ", "2sm":"عَرَفْتَ", "2dm":"عَرَفْتُمَا", "2pm":"عَرَفْتُمْ", "2sf":"عَرَفْتِ", "2df":"عَرَفْتُمَا", "2pf":"عَرَفْتُنَّ", "1s":"عَرَفْتُ", "1p":"عَرَفْنَا" },
    ...
    sajada: { en: "prostrate", pastEn: "prostrated", part: "prostrated", ar: {
...
const objects = {
    ...
    masjid:   { en: "mosque", ar: "الْمَسْجِدَ", arJer: "الْمَسْجِدِ", type: "place" },
    ...
    makan:    { en: "the place", ar: "الْمَكَانَ", arJer: "الْمَكَانِ", type: "place" },
    ard:      { en: "the ground", ar: "الْأَرْضَ", arJer: "الْأَرْضِ", type: "place" },
    ...
    obj_them_d:{ en: "them (dual)", subEn: "They (2)", suffix: "هُمَا", p: "3dm", type: "pronoun" },
    ...
    obj_you_dm:{ en: "you (2m)", subEn: "You (2m)", suffix: "كُمَا", p: "2dm", type: "pronoun" },
    obj_you_pm:{ en: "you (m-pl)", subEn: "You (m-pl)", suffix: "كُمْ", p: "2pm", type: "pronoun" },
    obj_you_f: { en: "you (f)", subEn: "You (f)", suffix: "كِ", p: "2sf", type: "pronoun" },
    obj_you_pf:{ en: "you (f-pl)", subEn: "You (f-pl)", suffix: "كُنَّ", p: "2pf", type: "pronoun" },
    obj_me:    { en: "me", subEn: "I", suffix: "نِي", p: "1s", type: "pronoun" },
    obj_us:    { en: "us", subEn: "We", suffix: "نَا", p: "1p", type: "pronoun" }
};

const predicates = {
    muslim: { en: "Muslim", ar: { "3sm":"مُسْلِمٌ", "1s":"مُسْلِمٌ" } }
};
...
function getPassiveAr(vKey, tense, person) {
    ...
    if (isPast) {
        ...
        const endings = { 
            "3sm":"َ", "3sf":"َتْ", "3dm":"َا", "3df":"َتَا", "3pm":"ُوا", "3pf":"ْنَ",
            "2sm":"ْتَ", "2sf":"ْتِ", "2dm":"ْتُمَا", "2pm":"ْتُمْ", "2pf":"ْتُنَّ",
            "1s":"ْتُ", "1p":"ْنَا" 
        };
...
function build() {
    if (!elements.subj.value || !elements.verb.value) return;
    ...
    if (type === "nominal") {
        ...
        let verbBe = s.p === "1s" ? "am" : (s.p.startsWith("2") || s.n !== "s" ? "are" : "is");
        elements.enOut.textContent = `${s.en} ${verbBe} a ${p.en}.`;
        return;
    }
    ...
    if (mode === "passive") {
        if (obj.type === "place") {
            ...
            enRes = `It ${be} ${v.part} ${prep.en || "to"} ${obj.en}.`;
        } else if (obj.type === "pronoun") {
            const vAr = getPassiveAr(elements.verb.value, tense, obj.p);
            arParts = [vAr];
            const be = getEnglishBe(obj.p, tense);
            enRes = `${obj.subEn} ${be} ${v.part}.`;
        } else {
            const vAr = getPassiveAr(elements.verb.value, tense, "3sm");
        ...
        if (obj.type === "pronoun") {
            if (prep.ar !== "") arParts.push(prep.ar + obj.suffix);
                ...
                let vWithSuf = arParts.pop() + obj.suffix; 
                arParts.push(vWithSuf); 
            }
        } else {
        ...
        if (tense === "past") {
            ...
            const vCap = v.en.charAt(0).toUpperCase() + v.en.slice(1);
            enRes = mode === "negative" ? `Do not ${v.en} ${pEn}${obj.en}!` : `${vCap} ${pEn}${obj.en}!`;
        }
    }
...
function init() {
    ...
    const inputs = [elements.type, elements.subj, elements.verb, elements.obj, elements.prep, elements.tense, elements.mode];
    inputs.forEach(i => {
        if (i) i.onchange = () => {
